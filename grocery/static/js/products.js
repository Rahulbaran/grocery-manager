...
const newProductsContainer = document.querySelector('.new__products__fields__container')
...
const productsMainContainer = document.querySelector('.products--main--container');
        ...
        if (res.status === 200) {
            ...
            .then(res => {
                ...
                if(res.alreadyExistProducts) {
                    ...
                    productsMainContainer.insertAdjacentHTML('afterbegin',msg);
                }
            });
        }
